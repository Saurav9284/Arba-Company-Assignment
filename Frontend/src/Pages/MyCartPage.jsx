...
import { AddtoCart, ChangeQuanity } from "../Redux/product/product.action";
...
function MyCartPage() {
  ...
  return (
    <div>
      <h1 className={style.heading} style={{textAlign:"center",fontSize:"50px",fontWeight:"bolder"}}>My Cart</h1>
      {tot > 0 ? (
        <div className={style.products}>
          {data?.filter((e) => e.added == true)
            .map((e, i) => (
...

{
  ...
  <div className={style.bottomsection}>
    <div className={btn.btmbtn} style={{marginBottom:"20%"}}>
